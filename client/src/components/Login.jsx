...
const Login = ({closeBtn , onSwitchToLogin}) => {
  ...
  return (
    <>
   <div className="fixed inset-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center px-4 sm:px-0">
  <form
    className="relative bg-white w-full max-w-sm sm:max-w-md p-6 sm:p-10 rounded-xl text-slate-500"
  ...
  >
    ...
    <p className="text-sm text-center mb-4">Welcome back! Please login to continue</p>
